        ...
        <div class="card-body">
            ...
            <form method="post" action="<?= htmlspecialchars($basePath . '/platform/packs/upsert', ENT_QUOTES, 'UTF-8') ?>" class="sheet-stack">
                    ...
                    <div class="section-content">
                        <div class="contact-form-grid">
                            <div class="field contact-field-full">
                                ...
                                <input class="input" type="text" name="name" required maxlength="120" placeholder="Ex: Pro BTP">
                            </div>
                            <div class="field">
                                <label class="label">Nombre d'utilisateurs</label>
                                <input class="input" type="number" name="max_users" min="1" required placeholder="Ex: 10">
                            </div>
                            <div class="field">
                                <label class="label">Prix</label>
                                <input class="input" type="number" step="0.01" min="0" name="price" required placeholder="Ex: 129.00">
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="inline-actions">
                    <button class="btn btn-primary" type="submit">Créer le pack</button>
