...
// Variables: $permissionDenied, $project, $kpiQuoteAmount, $kpiInvoiceAmount, $kpiPaidAmount, $kpiRemainingAmount, $quotesCount, $quotes, $activeQuote, $quoteVersions, $quoteVersionIndex, $quoteItemsByQuoteId, $invoicesCount, $reports, $photos
        ...
        <div class="card-header sheet-header">
            ...
            <div class="sheet-headline">
                ...
                <div style="display:flex; gap:8px; flex-wrap:wrap;">
                    ...
                    <?php if (!empty($canAssignTeam)): ?>
                        <a class="btn btn-secondary" href="<?= htmlspecialchars($basePath . '/projects/assign?projectId=' . (int) ($project['id'] ?? 0), ENT_QUOTES, 'UTF-8') ?>">Équipe</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                        ...
                        <div class="section-content quote-block">
                            <?php if (!empty($activeQuote)): ?>
                                <?php
                                    ...
                                    $qTotalTtc = $qTotal * (1 + ($vatRate / 100));
                                ...
                                <div class="quote-entry">
                                    <div class="quote-entry-section">
                                        ...
                                        <div class="table-wrap">
                                            <table class="table quote-items-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php else: ?>
                                                        <tr>
                                                            <td colspan="5" class="muted quote-empty">Aucune prestation sur ce devis.</td>
                                                        </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="quote-summary">
                                            ...
                                            <div class="quote-summary-item">
                                                <span class="quote-summary-label">Total TTC (<?= htmlspecialchars((string) number_format($vatRate, 2, ',', ' '), ENT_QUOTES, 'UTF-8') ?>%)</span>
                                            ...
                                            <div class="quote-summary-item">
                                                ...
                                                <strong class="quote-summary-value"><?= (int) $qTotalMinutes ?> min</strong>
                                            </div>
                                        </div>
                                            ...
                                            <div style="padding:10px 12px 12px;">
                                                <div class="inline-actions">
                                                    ...
                                                    <?php if (!empty($canSendQuote) && $canValidateThisQuote): ?>
                                                        <form method="POST" action="<?= htmlspecialchars($basePath . '/projects/quotes/validate', ENT_QUOTES, 'UTF-8') ?>" enctype="multipart/form-data" style="display:flex; flex-wrap:wrap; gap:8px; align-items:center;">
                                                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                                            <input type="hidden" name="project_id" value="<?= (int) ($project['id'] ?? 0) ?>">
                                                            <input type="hidden" name="quote_id" value="<?= $activeQid ?>">
                                                            <?php if (!empty($proofRequired)): ?>
                                                                <label class="label" style="margin:0; min-width:140px;">Preuve (PDF ou image)</label>
                                                                <input class="input" type="file" name="proof_document" accept=".pdf,application/pdf,image/*" required style="max-width:260px;">
                                                            <?php endif; ?>
                                    ...
                                    <?php foreach ($invoices as $inv): ?>
                                        ...
                                        <div style="border:1px solid #dbe7ef; border-radius:12px; padding:12px; background:linear-gradient(180deg,#ffffff 0%,#f8fbff 100%);">
                                            <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:12px; flex-wrap:wrap;">
                                                ...
                                                <span class="status-pill"><?= htmlspecialchars($invStatusLabel, ENT_QUOTES, 'UTF-8') ?></span>
                                            </div>
                                            ...
                                            <?php if (!empty($canInvoiceSend) && in_array($invStatus, ['brouillon', 'echue'], true)): ?>
                                                <form method="POST" action="<?= htmlspecialchars($basePath . '/invoices/send', ENT_QUOTES, 'UTF-8') ?>" style="margin-top:10px; display:flex; justify-content:flex-end;">
                                                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                                    <input type="hidden" name="project_id" value="<?= (int) ($project['id'] ?? 0) ?>">
                    ...
                    <div class="settings-grid">
                        <div class="section-card">
                            <div style="display:flex; align-items:center; justify-content:space-between; gap:8px;">
                                <h3 class="section-title" style="margin:0 0 8px;">Derniers rapports</h3>
                        ...
                        <div class="section-card">
                            <div style="display:flex; align-items:center; justify-content:space-between; gap:8px;">
                                <h3 class="section-title" style="margin:0 0 8px;">Dernières photos</h3>
