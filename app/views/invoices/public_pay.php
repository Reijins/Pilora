    ...
    <table>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td class="col-ht"><?= htmlspecialchars(number_format($totHt, 2, ',', ' '), ENT_QUOTES, 'UTF-8') ?> €</td>
                <td class="col-ttc">—</td>
            </tr>
            <?php foreach ($vatByRate as $vr): ?>
                ...
                <tr>
                    ...
                    <td class="col-ht">—</td>
                    <td class="col-ttc"><?= htmlspecialchars(number_format((float) ($vr['vat'] ?? 0), 2, ',', ' '), ENT_QUOTES, 'UTF-8') ?> €</td>
                </tr>
            <?php endforeach; ?>
            <?php if ($vatByRate === []): ?>
            <tr>
                ...
                <td class="col-ht">—</td>
                <td class="col-ttc"><?= htmlspecialchars(number_format($vatAmt, 2, ',', ' '), ENT_QUOTES, 'UTF-8') ?> €</td>
            </tr>
            <?php endif; ?>
            <tr>
                <td colspan="5" class="totals-label">Total TTC</td>
                <td class="col-ht">—</td>
                <td class="col-ttc"><?= htmlspecialchars(number_format($totTtc, 2, ',', ' '), ENT_QUOTES, 'UTF-8') ?> €</td>
            </tr>
        </tfoot>
    </table>
